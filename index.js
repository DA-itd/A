...
// Versión: 2.0.1 - Compatibilidad mejorada con Babel
...
const getRegistrationByCurp = async (curp) => {
    // CAMBIO: Reemplazar ?. por && para compatibilidad
    ...
    try {
        ...
        if (result && result.success && result.data && result.data.registeredCourses) {

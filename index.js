...
// Versión: 5.0.0 - Diseño Moderno + Campo Género + Validación Estricta
// =============================================================================
...
const handleNameChange = (e) => {
    ...
    if (teacher) {
        ...
        // Verificar inmediatamente si seleccionó de la lista
...
const handleNext = async () => {
    if (!validate()) return;
    setIsChecking(true);
    // Doble verificación forzada antes de avanzar
...
<description>Contenedor base para la aplicación de inscripciones.</description>
<content><![CDATA[
...
<footer class="bg-blue-800 text-white text-center p-4 mt-auto">
    <p class="font-semibold text-sm sm:text-base">© Coordinación de actualización docente - M.C. Alejandro Calderón Rentería.</p>
...
<script>
    window.CONFIG = {
        ...
        // IMPORTANTE: Después de actualizar el código en Google Apps Script,
        // debe ir a "Implementar" > "Nueva implementación" para que los
        // cambios se apliquen. Copie la nueva URL que se genera y péguela aquí.
...
<!-- Carga el archivo index.js que contiene toda la lógica -->

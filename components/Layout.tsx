...
const { Outlet, NavLink } = window.ReactRouterDOM;
    ...
    <header className="bg-white shadow-xl sticky top-0 z-40">
        <div className="container mx-auto px-4 py-4 sm:py-6">
            <div className="flex items-center justify-between gap-4">
                <a href="/"><img src="https://cdn.jsdelivr.net/gh/DA-itd/web/TecNM_logo.jpg"
                     alt="TecNM"
                     className="h-12 sm:h-16 md:h-20 object-contain" /></a>
                ...
                <a href="/"><img src="https://cdn.jsdelivr.net/gh/DA-itd/web/logo_itdurango.png"
                     alt="ITD"
                     className="h-12 sm:h-16 md:h-20 object-contain" /></a>
            </div>
        </div>
